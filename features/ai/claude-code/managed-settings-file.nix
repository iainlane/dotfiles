{
  ...
  # Claude Code watches the resolved file's parent directory. Keep the file in
  # a dedicated store directory so Nix store changes do not make Claude Code
  # scan every top-level store entry.
