{
  ...
  inputs = {
    ...
    # Swift -> dotnet -> pre-commit build chain broken on aarch64-darwin.
    # https://hydra.nixos.org/job/nixpkgs/trunk/swift.aarch64-darwin
    # Remove once Swift builds again on Hydra.
    nixpkgs-swift-fix.url = "github:nixos/nixpkgs/3327b113f2ef698d380df83fbccefad7e83d7769";
