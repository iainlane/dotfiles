# Work profile - employer project directories and work-specific tooling.
#
# Similar to the home profile, but for work contexts. Defines project
# directories with work email/identity and includes work-specific packages.
#
# Only include this on work machines. The `homeModule` in your host file can
# override git email and other settings for the whole machine if needed.
{
  inputs,
  config,
  withSystem,
...
in {
  ...
  flake.homeManagerModules.work = {pkgs, ...} @ args:
    lib.recursiveUpdate
