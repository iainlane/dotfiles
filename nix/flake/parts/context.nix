...
let
  ...
  # Override cosign to build with Go 1.25.3 until nixpkgs catches up.
  cosignGo1253Overlay = final: prev: let
    ...
    buildGoModuleWithGo1253 = prev.buildGoModule.override {go = go_1_25_3;};
  in {
    cosign = prev.cosign.override {buildGoModule = buildGoModuleWithGo1253;};
  };
