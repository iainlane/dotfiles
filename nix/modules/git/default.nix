{
  ...
  programs.git = {
    ...
    settings = {
      ...
      # Rewrite SSH GitHub URLs to HTTPS. This applies to all git operations
      # (clone, fetch, push), allowing us to use `gh` for authentication rather
      # than managing SSH keys.
