...
def clean_environment(
    ...
    targets are unavailable inside the sandbox. Every isolated process is
    therefore given the packaged bundle, which lives in the Nix store and is
    already readable to all of them.
    """
