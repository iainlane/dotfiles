...
# `AppleInterfaceStyle`. Both arms accept custom theme names via
# `~/.pi/agent/system-theme.json`, which lets the Pi module map the detected
# mode to the matching Catppuccin theme it renders.
#
